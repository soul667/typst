...
#let events = (
  (datetime(year: 2024, month: 5, day: 4, hour: 9, minute: 0, second: 0), [Lecture]),
...
#let events2 = (
  (datetime(year: 2024, month: 5, day: 1, hour: 9, minute: 0, second: 0), 
 
  ([Lectur111111e], blue)),
  (datetime(year: 2024, month: 5, day: 1, hour: 10, minute: 0, second: 0), ([Tutorial111111], red)),
  (datetime(year: 2024, month: 5, day: 1, hour: 11, minute: 0, second: 0), [Lab111111111111111111111111111111111111111111111111111111111111111111111111111111]),
)
#calendar-month(
  events2,
  sunday-first: true,
