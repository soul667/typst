...
// 设置16比9的幻灯片
#let s = university.register(aspect-ratio: "4-3")
...
#slide(header:"目录 CONTENTS")[
  ...
  // #set text(size: 1.2em)
  // #set text(size: 1em)
#place(left,dx:0em,dy:3em,[
#text(size: 32pt, fill: rgb("#19448e"), weight: "bold",[1.基本信息])

#text(size: 32pt, fill: rgb("#19448e"), weight: "bold",[2.获得荣誉])

#text(size: 32pt, fill: rgb("#19448e"), weight: "bold",[3.竞赛获奖])

#text(size: 32pt, fill: rgb("#19448e"), weight: "bold",[4.科研/项目经历])

#text(size: 32pt, fill: rgb("#19448e"), weight: "bold",[5.其他影响
])
])
  // #touying-outline()
]
...
// #h(5em)
  // == 1111222222
// 11
#place(left,dy:2.0em,dx:2em,[
  #image(data.第一页.照片链接,width: 6.5em)
])
// 左边放你的大头照
#place(left,dx:11em,dy:2.7em,[
...
#slide(header:"2 获得荣誉")[
#place(left,dy: 0.7em,dx:0em, university.竞赛获奖("11",文字22,"./img/院长特别奖学金.jpg",  10.9em,48%))
#place(left,dy:0.7em,dx:15em, university.竞赛获奖("11",文字23,"./img/先进个人.jpg", 10.9em,48%))
...
#let 文字专利=[
  #text(size: 0.7em, fill: rgb("#19448e"), weight: "bold", "第一作者发表发明专利2项")
  #text(size: 0.3em, "（未授权）")
...
#place(left,dy:2.9em,dx:0.2em,  university.竞赛获奖("11",文字24,"./img/竞赛经历v1.0.drawio.svg",19.2em,71%))
#place(left,dy:4.1em,dx:21.2em,  image("img/创梦之翼介绍.drawio.svg",width: 7em))

]
#slide(header:"3.1 比赛任职经历")[
#place(left,dy:2.5em,dx:-1.2em,  university.竞赛获奖("11",[
    #text(size: 0.6em, fill: rgb("#19448e"), weight: "bold", "RoboMaster 2024 区域赛合照（武汉）")
],"./img/武汉参赛照片.jpg",14.2em,53%))
// #place(left,dy:2.1em,dx:23.7em,  image("img/创梦之翼介绍.drawio.svg",width: 6em))
#place(left,dy:2.5em,dx:14.3em,  university.竞赛获奖("11",[
    #text(size: 0.6em, fill: rgb("#19448e"), weight: "bold", "第十八届挑战杯合照（贵州）")
],"./img/挑战杯合照.jpg",14.2em,52%))
]
#slide(header:"3.2  获得国家级特等奖一项，二等奖一项")[
#place(left,dy:2.6em,dx:0em, university.竞赛获奖("11",文字2,"./img/面向核电领域高性能智能检测获奖证书.png",15em,56%))
#place(left,dy:1.2em,dx:17em,  university.竞赛获奖("11",文字2_,"./img/RoboMaster全国赛获奖证书.jpg",9.2em,42%))
]
#slide(header:"3.3  省奖2 项,第一作者发表发明专利两项.")[
// #place(left,dy:0.7em,dx:2em, university.竞赛获奖("11",文字2,"./img/面向核电领域高性能智能检测获奖证书.png",15em,51%))
#place(left,dy:0.7em,dx:-1em,  university.竞赛获奖("11",文字21,"./img/RoboMaster区域赛获奖证书.jpg",9.2em,40%))
// #place(left,dy:0.7em,dx:12em,  university.竞赛获奖("11",文字专利,"./img/一种轮足式机器人腿部结构-受通.jpg",7.2em,45%))


#place(left,dy:0.8em,dx:11em,  university.专利_两个图片("11",文字专利,"./img/一种轮足式机器人腿部结构-受通.jpg","./img/一种轮足切换式机器人-受通.jpg",0em,9.7em,65%))
...
//   ]
//   )
#place(left,dx:1.8em,dy:2.3em,[
#image("./img/项目概述.drawio.svg",width: 25em)
...
// #h(5em)
#place(left,dx:-1.2em,[
#image("./img/自瞄系统示意图-修正.drawio.svg",width: 29em)
...
#image("./img/能量机关击打系统.drawio.svg",width: 29em)
#place(right+bottom,dx:-0.8em,dy:-3.8em,[
  #tablex(
  columns: 2,
  align: left + horizon,
  auto-vlines: false,
...
#place(center,dx:-0.6em,dy:3em,[
  #image("./img/挑战杯项目.drawio.svg",width: 29em)
])
...
#place(center,dx:0em,dy:1em,[
#image("./img/海洋水质监测系统-嵌入式.drawio.svg",width: 28em)
])
]

#slide(header:"4.6 海洋水质监测系统-后台（课程设计）")[
#place(center,dx:0em,dy:2.8em,[
#image("./img/海洋水质监测系统-后台系统.drawio.svg",width: 28em)
])
]
...
= 06 研究生规划
#slide(header:"6 研究生规划-大四")[
#v(1em)
== 大四
在大四，一方面我将继续提高自己的英语水平，将IETS考到6.5分以上，六级460分以上，具有良好的听说读写能力（大二大三因为将自己的重心放在竞赛上，耽误了英语的学习）。

另一方面，我将着重培养自己的科研能力，将自己在竞赛中的实践创新能力应用到科研中来，认真完成自己的毕业设计，让自己为研究生生活做好准备。

同时，我还计划在寒假期间找一些企业的岗位进行实习（如果学校允许，更希望前往学校进行实习，提前适应），进一步扩宽自己对于自己未来发展的规划和对工业界的认知，同时增强自己的实践能力。

]

#slide(header:"6 研究生规划-研究生阶段")[
== 研究生阶段
在研究生阶段，我计划快速适应新环境，认真学习课程并完成学校安排的项目实践。

为了提升英语能力，我将日常养成阅读英文文献的习惯，并积极参加英语交流活动。

我会积极与导师和同学交流，阅读并整理文献，了解光电领域的前沿研究动态。

此外，我会根据自己的研究兴趣和就业意向选择合适的实习岗位，积累实际工作经验，提升职业技能，为未来的就业做好充分准备。
